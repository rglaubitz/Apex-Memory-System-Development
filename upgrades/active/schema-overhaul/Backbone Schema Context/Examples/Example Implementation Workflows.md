# APEX MEMORY - EXAMPLE IMPLEMENTATION WORKFLOWS

⚠️ **IMPORTANT: These are IMPLEMENTATION workflows, NOT schema design patterns.**

**What this document describes:**
- ✅ HOW data is extracted from documents (Graphiti extraction, Docling parsing)
- ✅ HOW data is processed and stored (Redis updates, database writes)
- ✅ HOW entities are created and linked (temporal workflows, saga pattern)

**This is IMPLEMENTATION logic - it describes the runtime behavior AFTER the schema is defined.**

**What this document does NOT describe:**
- ❌ WHAT entities exist (Tractor, Driver, FuelTransaction)
- ❌ WHAT properties entities have (unit_number, make, model)
- ❌ WHERE data is stored (Neo4j vs PostgreSQL vs Qdrant)
- ❌ WHICH relationships connect entities (Driver ASSIGNED_TO Tractor)

**For schema design principles (WHAT/WHERE), see:** [SCHEMA-PHILOSOPHY.md](../SCHEMA-PHILOSOPHY.md)

**For implementation details (HOW), see:** [IMPLEMENTATION.md](../IMPLEMENTATION.md)
